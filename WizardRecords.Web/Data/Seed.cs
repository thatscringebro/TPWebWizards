    ...
    public static class Seed {
        ...
        private static void SeedAll(this ModelBuilder builder) {
            var albums = new List<Album> {
                ...
                new Album(Guid.NewGuid(), "Soundtrack (OST)", "Koyaanisqatsi", ArtistGenre.SOUNDTRACK, AlbumGenre.MINIMALIST, "Orange Mountain Music", 199.99f, true, Media.VINYL, 1, "soundtrack_koyaanisqatsi.webp", Grade.VG_PLUS, Grade.VG, "-", "-", ""),
                new Album(Guid.NewGuid(), "Soundtrack (OST)", "Undertale", ArtistGenre.SOUNDTRACK, AlbumGenre.ELECTRONICA, "Iam8bit", 29.99f, true, Media.VINYL, 1, "soundtrack_undertale.webp", Grade.VG, Grade.M, "-", "-", ""),
                new Album(Guid.NewGuid(), "Soundtrack (OST)", "Après Ski", ArtistGenre.SOUNDTRACK, AlbumGenre.FUNK, "Trans-Canada International", 99.99f, true, Media.VINYL, 1, "soundtrack_apres_ski.webp", Grade.VG_PLUS, Grade.VG, "-", "-", ""),
                ...
                new Album(Guid.NewGuid(), "b e g o t t e n", "Geometric Lullaby", ArtistGenre.ELECTRONICA, AlbumGenre.VAPORWAVE, "(death cycle)", 34.99f, false, Media.VINYL, 1, "begotten_death_cycle.webp", Grade.NONE, Grade.NONE, "-", "-", ""),
