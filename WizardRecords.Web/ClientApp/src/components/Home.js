                        ...
                        <Row>
                            <Col md={4} className="d-flex">
                                <a href="/product/1" className="cardHREF h-100 card-width">
                                    <Card className="h-100 card-width" >
                                        <CardImg top className="card-img-top" src={require("./Images/CD/CDBase.png")} alt="Product 1" style={{ maxHeight: '200px', width: 'auto', objectFit: 'contain' }} />
                            ...
                            <Col md={4} className="d-flex">
                                <a href="/product/2" className="cardHREF h-100 card-width">
                                    <Card className="h-100 card-width">
                                        <CardImg top className="card-img-top" src={require("./Images/Vinyl/VinylBase.png")} alt="Product 2" style={{ maxHeight: '200px', width: 'auto', objectFit: 'contain' }} />
                                        <CardBody className="flex-grow-1">
                            ...
                            <Col md={4}>
                                <a href="/product/3" className="cardHREF h-100 card-width">
                                    <Card className="h-100 card-width">
                                        <CardImg top className="card-img-top" src={require("./Images/Vinyl/VinylBase.png")} alt="Product 3" style={{ maxHeight: '200px', width: 'auto', objectFit: 'contain' }} />
                                        <CardBody className="flex-grow-1">
                    ...
                    <Container>
                        ...
                        <Row>
                            <Col md={4} className="d-flex">
                                <a href="/product/1" className="cardHREF h-100 card-width">
                                    <Card className="h-100 card-width">
                                        <CardImg top className="card-img-top" src={require("./Images/Vinyl/VinylBase.png")} alt="Product 1" style={{ maxHeight: '200px', width: 'auto', objectFit: 'contain' }} />
                                        <CardBody className="flex-grow-1">
                    ...
                    <Container>
                        ...
                        <Row>
                            ...
                            <Col md={4} className="d-flex">
                                <a href="/product/2" className="cardHREF h-100 card-width">
                                    <Card className="h-100 card-width">
                                        <CardImg top className="card-img-top" src={require("./Images/CD/CDBase.png")} alt="Product 2" style={{ maxHeight: '200px', width: 'auto', objectFit: 'contain' }} />
                                        <CardBody className="flex-grow-1">
                            ...
                            <Col md={4} className="d-flex">
                                <a href="/product/3" className="cardHREF h-100 card-width">
                                    <Card className="h-100 card-width">
                                        <CardImg top className="card-img-top" src={require("./Images/CD/CDBase.png")} alt="Product 3" style={{ maxHeight: '200px', width: 'auto', objectFit: 'contain' }} />
                                        <CardBody className="flex-grow-1">
